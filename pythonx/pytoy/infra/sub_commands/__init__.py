try:
    from pytoy.infra.sub_commands.specs import ArgumentSpec, OptionSpec, Completion, SubCommandSpec, MainCommandSpec, CompletionContext, ContextType, ParsedArguments # noqa
    ...
    from specs import ArgumentSpec, OptionSpec, Completion, SubCommandSpec, MainCommandSpec, CompletionContext, ContextType, ParsedArguments # noqa
