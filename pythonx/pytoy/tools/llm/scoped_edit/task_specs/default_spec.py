...
from pytoy_llm.task.models import FunctionInvocationSpec, InvocationSpecMeta, LLMInvocationSpec, TaskSpec, TaskSpecMeta
...
class DefaultScopedEditTaskMaker:
    def make_task(self, document: str, contract: ScopedEditLLMContract) -> TaskSpec:
        ...
        edit_spec = make_scoped_edit_spec(document, contract)
