...
from pytoy.shared.ui.contract.buffer.models import URI
...
from pytoy.shared.ui.pytoy_buffer.impls.vscode.kernel import Document, VSCodeBufferKernel, VSCodeUri, normalize_lf_code
