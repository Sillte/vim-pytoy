...
class VimTTYExecutor(TTYApplicationExecutorProtocol):
    def __init__(
        ...
        self._job = None
        self._chan = None
        self._screen = Screen(self._config_request.width or 80, self._config_request.height or 24)
        ...
        self._events = ExecutorEvents(
            on_update=self._update_emitter.event, on_job_exit=self._jobexit_emitter.event
        )  # EventEmitter 等をまとめたクラス
        self._start()
