...
from pytoy.lib_tools.buffer_executor.buffer_job_manager import (
...
from pytoy.ui import PytoyBuffer, PytoyQuickfix, QuickfixRecord, handle_records
from pytoy.ui.pytoy_buffer import make_buffer, make_duo_buffers
from pytoy.ui.pytoy_quickfix import QuickfixCreator, QuickfixRecordRegex, to_quickfix_creator
        ...
        *,
        ...
        def wrapped_on_closed(buffer_job: BufferJobProtocol) -> None:
            ...
            if quickfix_creator:
                ...
                handle_records(PytoyQuickfix(), records=records, is_open=False)
            if on_closed:
                on_closed(buffer_job)

        param = BufferJobCreationParam(
            command=wrapped_command, stdout=self.stdout, stderr=stderr, cwd=cwd, env=env, on_closed=wrapped_on_closed
        )
