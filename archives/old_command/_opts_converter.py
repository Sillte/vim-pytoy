...
from pytoy.shared.old_command.models import NARGS, RangeCountOption
from pytoy.shared.old_command.protocol import CommandFunction, ConverterProviderProtocol
...
class _OptsConverter:
    ...
    def _decide_converter(self, target: CommandFunction, nargs: NARGS | None, rc_opt: RangeCountOption):
        """
