...
class VimBufferRangeHandler:
    ...
    def get_text(self, character_range: CharacterRange) -> str:
        ...
        def _resolve_cols(
            lines: list[str], firstline_start_col: int | None = None, lastline_end_col: int | None = None
        ) -> None:
    ...
    def replace_text(self, character_range: CharacterRange, text: str) -> CharacterRange:
        ...
        def _resolve_surrounding(
            insert_lines: list[str], firstline_prefix: str | None = None, lastline_suffix: str | None = None
        ) -> None:
            assert insert_lines
