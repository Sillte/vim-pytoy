...
class TerminalExecutorManagerClass:
    ...
    def get_executor(self, app_name: str, buffer_name: str | None = None, **app_init_kwargs) -> TerminalExecutor:
    ...
    def _make_executor(self, app_name: str, buffer_name: str = "__CMD__", **app_init_kwargs) -> TerminalExecutor:
